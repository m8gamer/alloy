...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/m8gamer/alloy/tree/master)

## Running locally

```sh
git clone https://github.com/m8gamer/alloyproxy.git
cd alloyproxy
node server.js
```
